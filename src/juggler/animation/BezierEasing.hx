/** This is a copy of Starling's BezierEasing class (except it doesn't use UInt) */
...
class BezierEasing 
{
	...
	*/
	...
	{
		var currentX:Float, t:Float, i:Int = 0;
	...
	{
		var currentSlope:Float, currentX:Float;
		
		for (i in 0...NEWTON_ITERATIONS)
		{
			currentSlope = getSlope(t, x1, x2);
